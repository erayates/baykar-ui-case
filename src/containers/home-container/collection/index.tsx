...
import WorldMap from "./world-map-part";
      ...
      <div className="max-w-screen-xl mx-auto inner-container py-20">
        <div className="space-y-10">
          <div className="space-y-8">
            <h2 className="text-3xl font-extrabold">Grow Your Collection</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_4fr] gap-20">
            <div>
              <ul className="md:space-y-4">
                {collectionList.map((item: ICollectionItem, _idx: number) => (
                  <Link href={item.href}>
                    <li
                      className="flex items-center space-x-4 p-4 hover:bg-white rounded-lg hover:shadow-lg group"
                      key={_idx}
                    >
            ...
            <div className="relative">
              <div className="shadow-macCard rounded-[20px] max-w-[759px] relative z-10 bg-white h-full">
              ...
              <div className="shadow-macCard absolute left-[94px] top-[105px] rounded-[20px] w-full max-w-[759px] z-20 bg-white">
                <div className="flex gap-[5px] p-4">
                  <div className="w-2 h-2 rounded-full bg-rose-600"></div>
                  <div className="w-2 h-2 rounded-full bg-amber-400"></div>
                  <div className="w-2 h-2 rounded-full bg-green-500"></div>
              ...
              <div className="shadow-macCard absolute top-[202px] right-0 bg-white rounded-[10px] z-30">
                <div className="relative h-[286px] w-[256px]">
                  <Image
...
const CollectionBackshapes: React.FC = () => {
  return (
    <div className="w-full mt-[172px] relative">
      <div className="h-[684px] w-full absolute bottom-0">
        <CollectionTop />
      </div>
      <div className="h-[564px] w-full absolute bottom-0">
        <CollectionMid />
      </div>
      <div className="h-[372px] w-full absolute bottom-0">
        <CollectionBottom />
      </div>
    </div>
  );
